...
<body>
    <div class="invitation">
        <h3>Group House Invitation</h3>
        <p>You are invited to a group house on Smart Socket Switch. Click to join.</p>
        <!-- Use onclick event to navigate to index.html -->
        <h3 class="join-button" onclick="window.location.href='index.html'">JOIN GROUP</h3>
    </div>
</body>
</html>
				...
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						...
						<a class="dropdown-item" href="profile.html"><i class="dw dw-settings2"></i> Setting</a>
							<a class="dropdown-item" href="help.php"><i class="dw dw-help"></i> Help</a>
	...
	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.html">
						<img src="vendors/images/logo-white-img.jpg" alt="" class=" dark-logo">
				<img src=" vendors/images/logo-img.jpg" alt="" class=" light-logo">     
			</a>
			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="Analyticss.php">Analyticss</a></li>
